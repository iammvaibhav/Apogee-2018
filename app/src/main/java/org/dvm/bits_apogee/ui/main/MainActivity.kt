...
class MainActivity : BaseActivity(), MainMvpView, View.OnClickListener, EventClickListener, OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        eventBottomSheet.setBackgroundColor(CC.getScreenColorFor(0).colorC)
        leftDrawer.setBackgroundColor(CC.getScreenColorFor(0).colorC)
        rightDrawer.setBackgroundColor(CC.getScreenColorFor(0).colorC)
    ...
    override fun onClick(view: View) {
        when (view.id) {
            ...
            R.id.options -> {
                eventBottomSheet.setBackgroundColor(currColor)
